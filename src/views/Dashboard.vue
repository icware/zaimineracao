        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">Primario</span>
                        <div class="text-900 font-medium text-xl">26000/ton</div>
                    </div>
                    <div class="flex align-items-center justify-content-center border-round"
                        style="width: 2.5rem; height: 2.5rem">
                        <i class="pi pi-sitemap text-green-500 text-2xl"></i>
                    </div>
                </div>
                <div class="flex justify-content-between">
                    <span class="text-red-500 font-medium">PDE: 50%</span>
                    <span class="text-500">Hors: 12:80</span>
                </div>
            </div>
        </div>
